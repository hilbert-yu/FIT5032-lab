...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        <li v-for="work in orwell[0].famousWorks" :key="work.title">
    ...
    <section class="lab-section">
      ...
      <!-- fill countries here -->
      <ul>
        <!-- Iterate through countries array and display each country. -->
      ...
      <p>Our #1 seller:</p>
      <!-- show top1 seller, which is To Kill a Mockingbird -->
      <span>{{ bookstores.topSellers[0] }}</span>
    </section>
    ...
    <section class="lab-section">
      ...
      <!-- TODO: code to highlight author "George Orwell" -->
      <ul>
